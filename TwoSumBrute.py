...
class ArrayVisualization(Scene):
    def construct(self):
        ...
        array_group.move_to(ORIGIN)  # Center the entire array
        ...
        target_text.move_to(ORIGIN + UP * 2)  # Center it at the top
        ...
        sum_text = Text("", font_size=24)
        sum_text.next_to(array_group, DOWN * 5)  # Position it further below the array
        self.add(sum_text)
